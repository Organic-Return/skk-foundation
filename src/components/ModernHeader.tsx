      ...
      >
        ...
        <div className="hidden lg:block">
          <div className="max-w-[1800px] mx-auto px-8">
            <div className="flex items-center justify-start gap-6 h-8">
              <button
        ...
        {/* Navigation Row: Left Nav | Logo | Right Nav */}
        <div className="max-w-[1800px] mx-auto px-8">
          <div className="flex items-center justify-between h-[76px]">
            ...
            <Link href="/" className="flex-shrink-0 relative z-10">
              <Image
                ...
                width={200}
                height={63}
                className="h-[73px] w-auto object-contain transition-all duration-500 brightness-0 invert"
                priority
              />
            </Link>
