...
const components: PortableTextComponents = {
  block: {
    ...
    h1: ({ children }: { children?: ReactNode }) => (
      <h1 className="text-3xl md:text-4xl font-serif font-light text-[#1a1a1a] dark:text-white mt-12 mb-6 tracking-wide">{children}</h1>
    ),
    ...
    return (
      <main className="min-h-screen pt-32">
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          ...
          <h1 className="text-4xl font-serif font-light text-[#1a1a1a] dark:text-white mb-4">Issue Not Found</h1>
        ...
        <section className="relative min-h-screen flex items-end">
          ...
          <div className="relative w-full pb-16 md:pb-24 pt-32">
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
              ...
              {/* Title */}
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-serif font-light text-white tracking-wide mb-6 max-w-4xl">
                {magazine.title}
              </h1>
