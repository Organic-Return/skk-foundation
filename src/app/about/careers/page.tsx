...
const QUERY = `*[_type == "sitePage" && slug.current == "careers"][0]{
  title,
  heroImageUrl,
  contentHtml,
  showContactForm,
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: data?.seo?.metaTitle || data?.title || 'Careers',
    description: data?.seo?.metaDescription || 'Real estate career opportunities at Retter & Company',
