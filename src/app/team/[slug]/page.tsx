...
export default async function TeamMemberPage({ params }: Props) {
  ...
  return (
    <main className="min-h-screen">
      {/* RC: Unified centered hero + bio (same layout for all agents) */}
      {isRC ? (
      <>
      <section className="rc-inverted relative py-16 md:py-24 bg-[var(--rc-navy)]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
          ...
          <div className="flex flex-col items-center">
            {/* Photo */}
            <div
              className="relative w-[225px] md:w-[300px] overflow-hidden mb-8 bg-white/5"
            ...
            {/* Name & Title */}
            <h1
              className="text-3xl md:text-4xl lg:text-5xl font-light uppercase tracking-[0.08em] text-white mb-3 text-center"
              style={{ fontFamily: 'var(--font-figtree), Figtree, sans-serif', lineHeight: '1.1em' }}
            >
              {member.name}
            </h1>
            {member.title && (
              <p className="text-lg font-light mb-4 text-[var(--rc-gold)]">
                {member.title}
              </p>
            )}
      ...
      {/* Bio Section */}
      {member.bio && (
        <section className="rc-inverted py-16 md:py-24 bg-[var(--rc-navy)]">
